...
function renderMainContent() {
  ...
  <div class="profile-header">
    <h2 id="profile-username">Your Profile</h2>
...
function fetchUserProfile() {
  ...
  // Clear existing data
  profileUsernameElement.textContent = "Loading...";
  followersCountElement.textContent = "Followers: 0";
  followingCountElement.textContent = "Following: 0";
  userRecipesContainer.innerHTML = "<p>Loading uploads...</p>";
  ...
  fetch(`${baseUrl}/profile/stats`, {
    ...
    .catch((err) => {
      ...
      followersCountElement.textContent = "Followers: Error";
      followingCountElement.textContent = "Following: Error";
    });
  ...
  fetch(`${baseUrl}/users/profile`, {
    ...
    .then((uploads) => {
      if (!uploads || uploads.length === 0) {
        userRecipesContainer.innerHTML = "<p>No uploads found.</p>";
      } else {
      ...
      profileUsernameElement.textContent = "Your Profile";
    })
    .catch((err) => {
      console.error("Error fetching uploads:", err.message);
      userRecipesContainer.innerHTML = "<p>Error loading uploads. Please try again later.</p>";
    });

  // Toggle visibility of the profile section
  toggleSectionVisibility("user-profile-section");
}
